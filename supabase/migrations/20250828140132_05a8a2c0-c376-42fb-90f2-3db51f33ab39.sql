-- Update the process_email_triggers function to directly call the send-email edge function
...
-- Create a function to call the process-pending-emails edge function (useful for testing and manual triggers)
